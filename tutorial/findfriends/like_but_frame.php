...
if (isset($_POST['unlikebutton_'])) {
 ...
 $remove_user = mysql_query("DELETE FROM user_likes WHERE uid='$uid' AND username='$username'");
 header("Location: like_but_frame.php?uid=$uid");
}
 }
}

//Check for przevious likes
$check_for_likes = mysql_query("SELECT * FROM user_likes WHERE username='$username' AND uid='$uid'");
