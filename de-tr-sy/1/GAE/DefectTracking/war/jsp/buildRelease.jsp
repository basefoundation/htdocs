							...
							<tr>
								...
								<table width="700" height="562" border="1" bordercolor="#ABCC6A"
									...
									<tr>
										...
										<tr>
										<td width="25"></td>
										<td align="left" class="label_text">Linked Builds:</td>
										</tr>
										<tr>
										<td width="25"></td>
											<td><textarea cols="65" rows="20"> build not available</textarea></td>
										</tr>
										
										<tr>
											<td width="25"></td>
											<td align="left" class="label_text">Candidate Release:</td>
										</tr>
										</table>
